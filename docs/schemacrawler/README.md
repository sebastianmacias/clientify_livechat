...
# First find out under which docker network the "github.com/sebastianmacias/clientify_livechat" project is available (as started via ./docker-helper.sh --up).
